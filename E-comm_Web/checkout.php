...
<head>
    ...
    <title>Sab Lay Jao | Checkout</title>
...
<body>
    ...
    <section class="display-order">
        ...
        <div class="grand-total">Grand Total : Rs. <span><?php echo $grand_total; ?></span></div>
    ...
    <section class="checkout">
        <form action="" method="post">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    <span>Zip Code: </span>
                    <input type="number" min="0" name="pin_code" required placeholder="e.g. 54000">
                </div>
            </div>
